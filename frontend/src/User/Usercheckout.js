export default function Usercheckout(){
    return(
        <>
    <div className="container-fluid p-5 back-img"style={{ height:"710px"}}>
            ...
            <div className="card ">
                <div className="card-header">
                    <div className="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                        ...
                        <ul role="tablist" className="nav bg-light nav-pills rounded nav-fill mb-3" style={{borderRadius:"1rem"}}>
                            <li className="nav-item"> <a data-toggle="pill" href="#credit-card" className="nav-link active " > <i className="fas fa-credit-card mr-2"></i> Credit / Debit Card </a> </li>
                            
                            <li className="nav-item"> <a data-toggle="pill" href="#credit-card" className="nav-link active " > <i className="fas fa-credit-card mr-2"></i>UPI </a> </li>
                    ...
                    <div className="tab-content">
                        ...
                        <div id="credit-card" className="tab-pane fade show active pt-3">
                            <form role="form" onsubmit="event.preventDefault()" style={{height:"70px"}}>
                                ...
                                <div className="form-group"> <label for="cardNumber">
                                    ...
                                    <div className="input-group"> <input type="text" name="cardNumber" placeholder="Valid card number" className="form-control " required/>
                                        <div className="input-group-append"> <span className="input-group-text text-muted"/> <i className="fab fa-cc-visa mx-1"></i> <i className="fab fa-cc-mastercard mx-1"></i> <i className="fab fa-cc-amex mx-1"></i> </div>
                                    </div>
                                </div>
                                <div className="row">
